...
import (
	...
	"ryanlawton.art/photospace/internal/api/auth"
	authhttp "ryanlawton.art/photospace/internal/api/auth/delivery/http"
	authmongo "ryanlawton.art/photospace/internal/api/auth/repository/mongo"
	authusecase "ryanlawton.art/photospace/internal/api/auth/usecase"
	"ryanlawton.art/photospace/internal/api/photo"
	photohttp "ryanlawton.art/photospace/internal/api/photo/delivery/http"
	photobucket "ryanlawton.art/photospace/internal/api/photo/repository/bucket"
	photomongo "ryanlawton.art/photospace/internal/api/photo/repository/mongo"
	photousecase "ryanlawton.art/photospace/internal/api/photo/usecase"
)
